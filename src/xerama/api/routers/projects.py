...
from xerama.api.deps import get_episode_render_repo, get_episode_repo, get_project_repo, get_series_repo
...
async def list_projects(repo: ProjectRepository = Depends(get_project_repo)) -> list[ProjectRecord]:
